...
const ProductList = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="text1">
        <h2 className="text">Product List</h2>
        <div className="bigcontainer">
          {productsData.map((product) => (
            <div className="container" key={product.id}>
              ...
              />
              <h3 className="mainmrp">Mrp: ₹{product.price.mrp}</h3>
              <p className="costmrp">Price: ₹{product.price.cost}</p>
              <p className="discount">discount: {product.price.discount}</p>
